  ...
  render() {
    return(
      <CardText>
        ...
        {this.person.gender === "male" ? " He" : " She"} is {this.person.employment ? `currently working as ${Data.jobs[Math.floor(Math.random() * Data.jobs.length + 1)]}` : "currently seeking a job"}
