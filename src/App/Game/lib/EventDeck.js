  ...
  neutralEvents: {
    primaryEvents: {
      "It's cold & flu season!": {
        ...
        solutions: [
          (props => new Solution (1, 2, `${props.family.primary.firstName} decides to fight through it and go to work anyway.`, `${props.family.primary.firstName} feels like ${props.family.primary.gender === "male" ? "his": "her"} cold is getting worse.`)),
          (props => new Solution (2, 2, `${props.family.primary.firstName} decides to take a half day to make it to the clinic.`, `${props.family.primary.gender === "male" ? "His" : "Her"} manager was very unhappy and said ${props.family.primary.firstName}'s pay would be docked.`))
        ]
      }
    },
    jobEvents: {
      primaryHasJob: {
        "Bonus Pay": {
          ...
          solutions: [
            (props => new Solution(1, 4, "Into a savings account for a rainy day", "Setting aside emergency funds is always a good decision.", `${props.family.primary.firstName} deposited a bonus check into a savings account`, {
              'income': 5,
              'wellbeing': 5
            })),
            (props => new Solution(2, 4, "Toward some healthy groceries", "Groceries for home-cooked meals are a healthy and cost-effective way to keep the family fed.", `${props.family.primary.firstName} used their bonus pay to buy groceries`, {
              'food': 5,
              'wellbeing': 5
            })),
            (props => new Solution(3, 4, "Set aside for living expenses", "Rent and mortgages are often the biggest expenses for families each month.", `${props.family.primary.firstName} used their bonus pay to offset living expenses`, {
              "housing": 5,
              "wellbeing": 5
            })),
            (props => new Solution(4, 4, "Schedule a visit with the family Doctor", "Even with insurance, co-pays and premiums can be barriers to seeking medical attention", `${props.family.primary.firstName} used a bonus check to cover a medical visit`, {
              "health": 5,
              "wellbeing": 5
            })),
