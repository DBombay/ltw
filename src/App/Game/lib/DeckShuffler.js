...
export default function shuffleTheDeck(family) {
  ...
  if (family.props.primary.employed) {
  ...
  if (family.props.primary.insured) {
  ...
  if (family.props.secondary.employed) {
  ...
  if (family.props.secondary.insured) {
  ...
  let shuffledEvents = shuffle(potentialEvents).splice(0, 8)
